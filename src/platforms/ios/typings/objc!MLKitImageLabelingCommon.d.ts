...
declare class MLKImageLabeler extends NSObject {
	...
	processImageCompletion(image: MLKVisionImage, completion: (p1: NSArray<MLKImageLabel>, p2: NSError) => void): void;

	resultsInImageError(image: MLKVisionImage): NSArray<MLKImageLabel>;
}
