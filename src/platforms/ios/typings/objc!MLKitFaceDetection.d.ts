...
declare class MLKFaceDetector extends NSObject {
	...
	processImageCompletion(image: MLKVisionImage, completion: (p1: NSArray<MLKFace>, p2: NSError) => void): void;

	resultsInImageError(image: MLKVisionImage): NSArray<MLKFace>;
}
