...
declare class MLKObjectDetector extends NSObject {
	...
	processImageCompletion(image: MLKVisionImage, completion: (p1: NSArray<MLKObject>, p2: NSError) => void): void;

	resultsInImageError(image: MLKVisionImage): NSArray<MLKObject>;
}
