...
declare class MLKBarcodeScanner extends NSObject {
	...
	processImageCompletion(image: MLKVisionImage, completion: (p1: NSArray<MLKBarcode>, p2: NSError) => void): void;

	resultsInImageError(image: MLKVisionImage): NSArray<MLKBarcode>;
}
