				...
				export module internal {
					export module firebase_messaging {
						export class zzaf {
							...
							public add(param0: androidNative.Array<number>): com.google.firebase.encoders.ValueEncoderContext;
				...
				export module internal {
					export module firebase_messaging {
						export class zzy {
							...
							public static values(): any /* androidNative.Array<com.google.android.gms.internal.firebase_messaging.zzy>*/;
						}
					}
				}
			}
		...
		export module firebase {
			export module messaging {
				export class NotificationParams {
					...
					public getLocalizationArgsForKey(param0: string): androidNative.Array<any>;
			...
			export module messaging {
				...
				export module RemoteMessage {
					export class Builder {
						...
						public setRawData(param0: androidNative.Array<number>): com.google.firebase.messaging.RemoteMessage.Builder;
					}
		...
		export module firebase {
			export module messaging {
				export class RemoteMessageCreator extends globalAndroid.os.Parcelable.Creator<com.google.firebase.messaging.RemoteMessage> {
					...
					public newArray(param0: number): androidNative.Array<com.google.firebase.messaging.RemoteMessage>;
				}
			}
		}
	}
