				...
				export module internal {
					export class CrashlyticsNativeComponent {
						...
						public constructor(implementation: {
							...
							openSession(param0: string): boolean;
							finalizeSession(param0: string): boolean;
							getSessionFileProvider(param0: string): com.google.firebase.crashlytics.internal.NativeSessionFileProvider;
							writeBeginSession(param0: string, param1: string, param2: number): void;
							writeSessionApp(param0: string, param1: string, param2: string, param3: string, param4: string, param5: number, param6: string): void;
							writeSessionOs(param0: string, param1: string, param2: string, param3: boolean): void;
							writeSessionDevice(param0: string, param1: number, param2: string, param3: number, param4: number, param5: number, param6: boolean, param7: number, param8: string, param9: string): void;
						});
						public constructor();
						...
						public openSession(param0: string): boolean;
						public writeSessionDevice(param0: string, param1: number, param2: string, param3: number, param4: number, param5: number, param6: boolean, param7: number, param8: string, param9: string): void;
						public finalizeSession(param0: string): boolean;
						public writeSessionApp(param0: string, param1: string, param2: string, param3: string, param4: string, param5: number, param6: string): void;
						public writeSessionOs(param0: string, param1: string, param2: string, param3: boolean): void;
						public writeBeginSession(param0: string, param1: string, param2: number): void;
					}
				}
			}
		}
...
declare module com {
	export module google {
		export module firebase {
			export module crashlytics {
				export module internal {
					export class ProviderProxyNativeComponent extends com.google.firebase.crashlytics.internal.CrashlyticsNativeComponent {
						public static class: java.lang.Class<com.google.firebase.crashlytics.internal.ProviderProxyNativeComponent>;
						public getSessionFileProvider(param0: string): com.google.firebase.crashlytics.internal.NativeSessionFileProvider;
						public hasCrashDataForSession(param0: string): boolean;
						public openSession(param0: string): boolean;
						public constructor(param0: com.google.firebase.inject.Provider<com.google.firebase.crashlytics.internal.CrashlyticsNativeComponent>);
						public writeSessionDevice(param0: string, param1: number, param2: string, param3: number, param4: number, param5: number, param6: boolean, param7: number, param8: string, param9: string): void;
						public finalizeSession(param0: string): boolean;
						public writeSessionApp(param0: string, param1: string, param2: string, param3: string, param4: string, param5: number, param6: string): void;
						public writeSessionOs(param0: string, param1: string, param2: string, param3: boolean): void;
					...
					export module ProviderProxyNativeComponent {
						export class MissingNativeSessionFileProvider extends com.google.firebase.crashlytics.internal.NativeSessionFileProvider {
							public static class: java.lang.Class<com.google.firebase.crashlytics.internal.ProviderProxyNativeComponent.MissingNativeSessionFileProvider>;
							public getMetadataFile(): java.io.File;
							public getOsFile(): java.io.File;
							public getMinidumpFile(): java.io.File;
							public getBinaryImagesFile(): java.io.File;
				...
				export module internal {
					export module common {
						export class CommonUtils {
							...
							public static hexify(param0: androidNative.Array<number>): string;
							/** @deprecated */
							...
							public static createInstanceIdFrom(param0: androidNative.Array<string>): string;
						...
						export module CommonUtils {
							export class Architecture {
								...
								public static values(): androidNative.Array<com.google.firebase.crashlytics.internal.common.CommonUtils.Architecture>;
							}
						}
					}
				}
				...
				export module internal {
					export module common {
						export class DeliveryMechanism {
							...
							public static values(): androidNative.Array<com.google.firebase.crashlytics.internal.common.DeliveryMechanism>;
					...
					export module log {
						export class FileLogStore {
							...
							public constructor(implementation: {
								...
								getLogAsBytes(): androidNative.Array<number>;
				...
				export module internal {
					export module log {
						export class QueueFile {
							...
							public clear(): void;
							public toString(): string;
							public add(param0: androidNative.Array<number>, param1: number, param2: number): void;
							public constructor(param0: java.io.File);
							public add(param0: androidNative.Array<number>): void;
						...
						export module CrashlyticsReport {
							...
							export module Session {
								...
								export abstract class Builder {
									...
									public build(): com.google.firebase.crashlytics.internal.model.CrashlyticsReport.Session;
									public setIdentifier(param0: string): com.google.firebase.crashlytics.internal.model.CrashlyticsReport.Session.Builder;
									public setIdentifierFromUtf8Bytes(param0: androidNative.Array<number>): com.google.firebase.crashlytics.internal.model.CrashlyticsReport.Session.Builder;
									public setOs(param0: com.google.firebase.crashlytics.internal.model.CrashlyticsReport.Session.OperatingSystem): com.google.firebase.crashlytics.internal.model.CrashlyticsReport.Session.Builder;
									public setEndedAt(param0: java.lang.Long): com.google.firebase.crashlytics.internal.model.CrashlyticsReport.Session.Builder;
								}
										...
										export module Execution {
											...
											export module BinaryImage {
												export abstract class Builder {
													...
													public setUuid(param0: string): com.google.firebase.crashlytics.internal.model.CrashlyticsReport.Session.Event.Application.Execution.BinaryImage.Builder;
													public build(): com.google.firebase.crashlytics.internal.model.CrashlyticsReport.Session.Event.Application.Execution.BinaryImage;
													public setUuidFromUtf8Bytes(param0: androidNative.Array<number>): com.google.firebase.crashlytics.internal.model.CrashlyticsReport.Session.Event.Application.Execution.BinaryImage.Builder;
													public setBaseAddress(param0: number): com.google.firebase.crashlytics.internal.model.CrashlyticsReport.Session.Event.Application.Execution.BinaryImage.Builder;
												}
											}
											export abstract class Builder {
				...
				export module internal {
					export module model {
						export class ImmutableList<E>  extends java.lang.Object {
							...
							public size(): number;
							public hashCode(): number;
							public static from(param0: androidNative.Array<any>): com.google.firebase.crashlytics.internal.model.ImmutableList<any>;
				...
				export module internal {
					export module stacktrace {
						export class MiddleOutFallbackStrategy extends com.google.firebase.crashlytics.internal.stacktrace.StackTraceTrimmingStrategy {
							...
							public constructor(param0: number, param1: androidNative.Array<com.google.firebase.crashlytics.internal.stacktrace.StackTraceTrimmingStrategy>);
						}
					}
				}
			}
				...
				export module internal {
					export module stacktrace {
						export class StackTraceTrimmingStrategy {
							 ...
							 */
							public constructor(implementation: {
								getTrimmedStackTrace(param0: androidNative.Array<java.lang.StackTraceElement>): androidNative.Array<java.lang.StackTraceElement>;
							});
							public constructor();
							public getTrimmedStackTrace(param0: androidNative.Array<java.lang.StackTraceElement>): androidNative.Array<java.lang.StackTraceElement>;
						}
